...
const Docs = (
  <div id="docs">
    <h1>Documentation</h1>
    <p>
      To determine how to spend transactions, each player has access to an their owned cells denoted{' '}
      <code>myCells (PlayerCell[])</code>.<br />
      Each algorithm's <code>turn</code> function will be called every round and should return a{' '}
      <code>transaction</code> object.
    </p>

    <h3>
      <code>PlayerCell</code>
    </h3>
    <ul className="list-view-indent">
      ...
      <li>
        <code>neighbors (NeighborCell[])</code>
        <br />
    ...
    <ul className="list-view-indent">
      <li>
        <code>NONE (int)</code>
        <br />
        Unoccupied hexagon controlled by no one.
      </li>
      <li>
        <code>OWN (int)</code>
        <br />
    ...
    <ul className="list-view-indent">
      <li>
        ...
        <br />
        Id of the cell from which resources will be taken.
      </li>
      <li>
        <code>toId (string)</code>
        <br />
        Id of the cell to receive the resources.
      </li>
      <li>
        <code>transferAmount (int)</code>
        <br />
        The amount of resources to be transfered.
      </li>
    </ul>
  </div>
);
