...
const Rules = <div id="rules">
    ...
    <ul className="list-view">
        ...
        <li>
            To take over a cell you must transfer resources from a cell that you own to one of its neighbors.<br />
        ...
        <li>After each round all cells occupied by players gain 1 resource, until they reach their natural growth max.</li>
    </ul>
    ...
    <ul className="list-view">
        ...
        <li>Transactions must include distinct cells - i.e. it is not possible for a cell to be both donor and recipient in a transaction.</li>
        <li>The cells of a transaction must be neighbors when attacking (transferring resources from an owned cell to a non-owned cell).</li>
        <li>Transaction between cells that are both owned by the player does not have to be neighbors, although they must still be connected through other cells of that player.</li>
    ...
    <ul className="list-view">
        ...
        <li>Getting through the mining field gives access to the rest of the grid, where unoccupied cells are freely available.</li>
