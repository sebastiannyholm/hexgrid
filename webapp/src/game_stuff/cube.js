class Cube {
    ...
    constructor(x, y, z, withSelfReferencing = true) {
        if (Math.round(x + y + z) !== 0)
            throw "cube coordinates must sum to 0";
        ...
        if (withSelfReferencing) {
            this.neighbors = [
                new Cube(this.x, this.y - 1, this.z + 1, false), new Cube(this.x + 1, this.y, this.z - 1, false), new Cube(this.x - 1, this.y + 1, this.z, false),
                new Cube(this.x, this.y + 1, this.z - 1, false), new Cube(this.x - 1, this.y, this.z + 1, false), new Cube(this.x + 1, this.y - 1, this.z, false)
            ];
            this.diagonals = [
                new Cube(this.x - 1, this.y - 1, this.z + 2, false), new Cube(this.x - 2, this.y + 1, this.z + 1, false), new Cube(this.x - 1, this.y + 2, this.z - 1, false),
                new Cube(this.x + 1, this.y + 1, this.z - 2, false), new Cube(this.x + 2, this.y - 1, this.z - 1, false), new Cube(this.x + 1, this.y - 2, this.z + 1, false)
            ];
        }
    }
